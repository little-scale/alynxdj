...
- **The 2 KB EEPROM ceiling** — Q1 is resolved and power-cycle-tested, but
  the current factory image already uses 1233/2032 packed bytes. Keep the
...
- **64 KB code packing** — after the M16 editor fixes, MAIN has 29 bytes free,
  HICODE1/HICODE3 have 2/15, HICODE2 has 1, and SONG/MIRRORRAM are exact fits; the C stack
  remains 640 bytes. Growth needs measured placement/reclamation, not an
